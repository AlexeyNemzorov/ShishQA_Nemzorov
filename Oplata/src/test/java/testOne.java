...
public class testOne {
    ...
    public void OrderTest() {
        ...
        driver.findElement(By.id("input-card-cvc")).click();
        driver.findElement(By.id("input-card-cvc")).sendKeys("777");
        String Order=driver.findElement(By.xpath("//*[@id=\"order-number\"]")).getText();
        driver.findElement(By.id("action-submit")).click();
        driver.findElement(By.xpath("//*[@id=\"success\"]")).click();
        driver.findElement(By.id("payment-status")).click();


        assertEquals(Order, driver.findElement(By.xpath("//*[@id=\"payment-item-ordernumber\"]/div[2]")).getText());
